...
- **Meeting recording** — captures your microphone and system audio simultaneously;
  transcripts label the two sides **You** / **Them** like a dialogue.
...
- **System-wide dictation** — press ⌥Space in any app, speak, then press it again;
  Scribe transcribes locally and inserts the result at the cursor (or copies it when
...
- **Transcript editor** — timestamped segments, click a timestamp to seek, playback
  follows along with highlighting, inline text editing, find/replace, editable speaker
  names and assignments, and adjustable speed (0.75×–2×).
- **Automatic cleanup** — optional filler-word removal plus reusable whole-word/case-aware
  replacement rules for names and terms Whisper commonly mishears.
...
- **AI summaries (optional)** — bring your own Anthropic or OpenAI key in Settings → AI.
  Without a key, nothing ever leaves the Mac.
